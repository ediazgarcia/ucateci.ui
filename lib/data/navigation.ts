    ...
    columns: [
      {
        ...
        items: [
          { title: "Historia", href: "/resena-historica", icon: Building2, description: "Más de 40 años de excelencia académica" },
          { title: "Misión y Visión", href: "/filosofia", icon: BookOpen },
          { title: "Identidad y Logosímbolo", href: "/logosimbolo", icon: GraduationCap },
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Reglamento Académico", href: "/reglamento-academico", icon: Scale },
          { title: "Manual Estudiantes", href: "/manual-estudiante", icon: GraduationCap },
          { title: "Trabaja en UCATECI", href: "/trabaja-en-ucateci", icon: Users },
